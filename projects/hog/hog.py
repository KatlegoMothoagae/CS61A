...
def play(strategy0, strategy1, update,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            score0 = update(dice_rolled, score0, score1, dice)

        elif who == 1:
            dice_rolled = strategy1(score1, score0)
            score1 = update(dice_rolled, score1, score0, dice)
...
def run_experiments():
    ...
    print('always_roll(6) win rate:', average_win_rate(always_roll(7))) 
